...
const LIVEKIT_URL = 'wss://mtv-bv2r1tkt.livekit.cloud'; // Thay đổi URL này
const API_KEY = 'APISBVnYaXLEf53'; // Thay đổi API key này
const API_SECRET = 'YzwvZoeERXePRHm4lWwj8WgvPS0E3CZVZh4wXxWVP34'; // Thay đổi API secret này
