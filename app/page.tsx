...
function DemoMeetingTab(props: { label: string }) {
  ...
  return (
    <div className={styles.tabContent}>Gifting livestream shows</p>
      ...
      <p style={{ margin: 0 }}>Donate from anywhere with BLKLUV.ORG Live</p>
...
function CustomConnectionTab(props: { label: string }) {
  ...
  return (
    <form className={styles.tabContent} onSubmit={onSubmit}>
      <p style={{ marginTop: 0 }}>
        Connect BLKLUV.ORG Live with a custom server using LiveKit Cloud or LiveKit Server.
      </p>
      <input
        id="serverUrl"
        name="serverUrl"
      ...
      <main className={styles.hpMain} data-lk-theme="default">
        ...
        <header className={styles.hpHeader}>
          <h1 className={styles.hpTitle}>
            <span className={styles.hpIg3}>BLKLUV.ORG</span>
            <span className={styles.hpMeet}>LIVE</span>
          </h1>
        </header>
        ...
        <div className={styles.hpContent}>
          <div className={styles.hpCard}>
            ...
            <p className={styles.hpCardDescription}>
              Donate as a tribe from anywhere with{' '}
              <span className={styles.hpCardDescriptionHighlight}>BLKLUV.ORG LIVE</span>
            </p>
        ...
        <footer className={styles.hpFooter}>
          <div className={styles.hpFooterLeft}>
            <p>@2025 BLKLUV.ORG LIVE. All rights reserved.</p>
          </div>
          <div className={styles.hpFooterRight}>
            <a href="https://x.com/blkluvorg" className={styles.hpSocialIcon} aria-label="Twitter">
